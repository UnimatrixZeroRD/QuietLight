...
export default function HomePage() {
  return (
    <main>
      ...
      >
        <div className="mx-auto mb-8 h-24 w-24 rounded-full border border-[var(--lantern-gold)] bg-[url('/images/brand/lantern-mark.svg')] bg-cover shadow-[0_0_60px_rgba(216,168,79,0.25)]" />
      ...
      <section className="mx-auto grid max-w-6xl gap-6 px-6 py-16 md:grid-cols-2">
        <div className="lantern-panel grid gap-8 rounded-3xl p-8 md:grid-cols-[0.75fr_1fr]">
          <div className="min-h-80 rounded-2xl border border-[var(--lantern-gold)] bg-[url('/images/books/keepers-lantern-cover.svg')] bg-cover bg-center" />
          <div>
