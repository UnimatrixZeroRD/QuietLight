...
export const dailyLightFutureEntriesBatchFour: DailyLightEntry[] = [
  {
    id: "daily-light-day-30-walking-in-the-light",
    slug: "day-30-walking-in-the-light",
    title: "Walking in the Light",
    summary: "The first volume concludes with a call to continue walking closely with Christ, carrying His light with humility, faithfulness, and love.",
    accessLevel: "public",
    status: "published",
    volume: "Volume One",
    volumeTitle: "Walking in the Light",
    day: 30,
    theme: "Living Every Day in the Presence of Christ",
    oldTestamentReading: "Psalm 119:105-112",
    newTestamentReading: "1 John 1:5-7",
    keyVerseReference: "1 John 1:7",
    keyVerseText: "But if we walk in the light, as he is in the light, we have fellowship one with another, and the blood of Jesus Christ his Son cleanseth us from all sin.",
    scriptureReference: "1 John 1:7",
    scriptureText: "But if we walk in the light, as he is in the light, we have fellowship one with another, and the blood of Jesus Christ his Son cleanseth us from all sin.",
    publishedOn: "2026-07-30",
    reflection: `The Christian life is not defined by a single decision but by a lifelong walk.
...
In the name of Jesus Christ, Amen.`,
    reflectionQuestion: "Looking back over these thirty days, what truth has God impressed most deeply upon my heart, and how will I live it out beginning today?",
    todayPractice: "Spend time reviewing the lessons from this first volume. Thank God for His faithfulness, and prayerfully commit yourself to continue growing in grace as you begin the next stage of your journey.",
    closingThought: "We are not the Light. We are simply called to walk so closely with Christ that His Light shines through us into the world.",
  },
];
