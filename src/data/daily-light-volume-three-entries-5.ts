...
export const dailyLightVolumeThreeEntriesBatchFive: DailyLightEntry[] = [
  {
    id: "daily-light-day-81-making-disciples",
    slug: "day-81-making-disciples",
    title: "Making Disciples",
    summary: "Every follower of Christ is called to help others grow in faith through faithful example, patient teaching, encouragement, and Gospel witness.",
    accessLevel: "public",
    status: "published",
    volume: "Volume Three",
    volumeTitle: "Living the Kingdom",
    day: 81,
    theme: "Sharing the Life of Christ",
    oldTestamentReading: "Deuteronomy 6:4-9",
    newTestamentReading: "Matthew 28:16-20",
    keyVerseReference: "Matthew 28:19-20",
    keyVerseText: "Go ye therefore, and teach all nations... teaching them to observe all things whatsoever I have commanded you.",
    scriptureReference: "Matthew 28:19-20",
    scriptureText: "Go ye therefore, and teach all nations... teaching them to observe all things whatsoever I have commanded you.",
    publishedOn: "2026-09-19",
    reflection: `The Kingdom of God was never intended to stop with us.
...
In His holy name, Amen.`,
    reflectionQuestion: "Who has God entrusted to my influence, and how can I help them grow in their faith?",
    todayPractice: "Encourage someone spiritually today. Share a verse of Scripture, pray with them, or simply speak about God's faithfulness in your own life.",
    closingThought: "The greatest legacy we leave is not what we accomplish, but whom we faithfully help follow Christ.",
  },
  {
    id: "daily-light-day-82-courage-without-fear",
    slug: "day-82-courage-without-fear",
    title: "Courage Without Fear",
    summary: "Kingdom courage is obedience in the presence of fear, trusting that God goes before His servants and remains with them.",
    accessLevel: "public",
    status: "published",
    volume: "Volume Three",
    volumeTitle: "Living the Kingdom",
    day: 82,
    theme: "Standing Firm for Christ",
    oldTestamentReading: "Joshua 1:1-9",
    newTestamentReading: "Acts 4:13-31",
    keyVerseReference: "Joshua 1:9",
    keyVerseText: "Be strong and of a good courage... for the LORD thy God is with thee whithersoever thou goest.",
    scriptureReference: "Joshua 1:9",
    scriptureText: "Be strong and of a good courage... for the LORD thy God is with thee whithersoever thou goest.",
    publishedOn: "2026-09-20",
    reflection: `Courage is not the absence of fear.
...
In His holy name, Amen.`,
    reflectionQuestion: "Is fear preventing me from obeying God in any area of my life?",
