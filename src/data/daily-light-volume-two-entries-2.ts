...
export const dailyLightVolumeTwoEntriesBatchTwo: DailyLightEntry[] = [
  {
    id: "daily-light-day-37-walking-in-humility",
    slug: "day-37-walking-in-humility",
    title: "Walking in Humility",
    summary: "Humility reflects the heart of Christ, teaching believers to serve quietly, reject pride, and delight in God's glory above their own.",
    accessLevel: "public",
    status: "published",
    volume: "Volume Two",
    volumeTitle: "Growing in Grace",
    day: 37,
    theme: "Becoming More Like Christ",
    oldTestamentReading: "Micah 6:6-8",
    newTestamentReading: "Philippians 2:1-11",
    keyVerseReference: "Micah 6:8",
    keyVerseText: "He hath shewed thee, O man, what is good... to do justly, and to love mercy, and to walk humbly with thy God.",
    scriptureReference: "Micah 6:8",
    scriptureText: "He hath shewed thee, O man, what is good... to do justly, and to love mercy, and to walk humbly with thy God.",
    publishedOn: "2026-08-06",
    reflection: `Humility is one of the greatest evidences of spiritual maturity.
...
In the name of Jesus Christ, Amen.`,
    reflectionQuestion: "Is there an area of my life where pride has prevented me from serving God or others faithfully?",
    todayPractice: "Quietly encourage or honor someone else's accomplishments today without drawing attention to your own.",
    closingThought: "The closer we draw to Christ, the less we seek our own glory and the more we delight in His.",
  },
  {
    id: "daily-light-day-38-learning-contentment",
    slug: "day-38-learning-contentment",
    title: "Learning Contentment",
    summary: "Contentment is learned by resting in Christ's sufficiency, trusting God's provision, and replacing comparison with gratitude.",
    accessLevel: "public",
    status: "published",
    volume: "Volume Two",
    volumeTitle: "Growing in Grace",
    day: 38,
    theme: "Finding Sufficiency in Christ",
    oldTestamentReading: "Psalm 23",
    newTestamentReading: "Philippians 4:10-13",
    keyVerseReference: "Philippians 4:11",
    keyVerseText: "I have learned, in whatsoever state I am, therewith to be content.",
    ...
    reflection: `Contentment is not something we naturally possess.
...
In the name of Jesus Christ, Amen.`,
    reflectionQuestion: "What desire or comparison has been stealing my contentment in Christ?",
