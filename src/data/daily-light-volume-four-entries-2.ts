...
export const dailyLightVolumeFourEntriesBatchTwo: DailyLightEntry[] = [
  {
    id: "daily-light-day-95-a-clean-heart",
    slug: "day-95-a-clean-heart",
    title: "A Clean Heart",
    summary: "Confession and repentance deepen worship by bringing every failure honestly before God and receiving the cleansing mercy of Christ.",
    accessLevel: "public",
    status: "published",
    volume: "Volume Four",
    volumeTitle: "The Heart of Worship",
    day: 95,
    theme: "Worship Through Confession and Repentance",
    oldTestamentReading: "Psalm 51:1-17",
    newTestamentReading: "1 John 1:5-10",
    keyVerseReference: "Psalm 51:10",
    ...
    reflection: `One of the greatest barriers to worship is an unconfessed heart.
...
In the name of Jesus Christ, Amen.`,
    reflectionQuestion: "Is there anything I have been reluctant to confess and surrender to God?",
    todayPractice: "Spend time in quiet self-examination before the Lord. Confess every known sin, receive His forgiveness with gratitude, and thank Him for His restoring grace.",
    closingThought: "A cleansed heart becomes a sanctuary where worship can freely flourish.",
  },
  {
    id: "daily-light-day-96-be-still-before-the-lord",
    slug: "day-96-be-still-before-the-lord",
    title: "Be Still Before the Lord",
    summary: "Stillness before God is trustful worship, making room to hear His Word, rest in His presence, and quiet the soul.",
    accessLevel: "public",
    status: "published",
    volume: "Volume Four",
    volumeTitle: "The Heart of Worship",
    day: 96,
    theme: "Listening in the Quiet",
    oldTestamentReading: "1 Kings 19:9-13",
    newTestamentReading: "Luke 10:38-42",
    keyVerseReference: "Psalm 46:10",
    keyVerseText: "Be still, and know that I am God.",
    scriptureReference: "Psalm 46:10",
    scriptureText: "Be still, and know that I am God.",
    publishedOn: "2026-10-04",
    reflection: `Our world is filled with noise.
...
In the name of Jesus Christ, Amen.`,
    reflectionQuestion: "What distractions most often prevent me from spending quiet time with God?",
