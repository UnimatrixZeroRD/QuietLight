...
import { dailyLightVolumeFourEntriesBatchThree } from "../../data/daily-light-volume-four-entries-3";
import { dailyLightVolumeFourEntriesBatchFour } from "../../data/daily-light-volume-four-entries-4";
import { dailyLightVolumeFourEntriesBatchFive } from "../../data/daily-light-volume-four-entries-5";
import { dailyLightVolumeFourEntriesBatchSix } from "../../data/daily-light-volume-four-entries-6";
import { dailyLightVolumeFourEntriesBatchSeven } from "../../data/daily-light-volume-four-entries-7";
import { dailyLightVolumeFiveEntries } from "../../data/daily-light-volume-five-entries";
import { dailyLightVolumeFiveEntriesBatchTwo } from "../../data/daily-light-volume-five-entries-2";
import { dailyLightVolumeFiveEntriesBatchThree } from "../../data/daily-light-volume-five-entries-3";
import { dailyLightVolumeFiveEntriesBatchFour } from "../../data/daily-light-volume-five-entries-4";
import { dailyLightVolumeFiveEntriesBatchFive } from "../../data/daily-light-volume-five-entries-5";
import { dailyLightVolumeFiveEntriesBatchSix } from "../../data/daily-light-volume-five-entries-6";
import { dailyLightVolumeFiveEntriesBatchSeven } from "../../data/daily-light-volume-five-entries-7";
import { dailyLightVolumeFiveEntriesBatchEight } from "../../data/daily-light-volume-five-entries-8";
import { dailyLightVolumeFiveEntriesBatchNine } from "../../data/daily-light-volume-five-entries-9";
import { dailyLightVolumeFiveEntriesBatchTen } from "../../data/daily-light-volume-five-entries-10";
import { dailyLightVolumeFiveEntriesBatchEleven } from "../../data/daily-light-volume-five-entries-11";
import { dailyLightVolumeFiveEntriesBatchTwelve } from "../../data/daily-light-volume-five-entries-12";
import { dailyLightVolumeFiveEntriesBatchThirteen } from "../../data/daily-light-volume-five-entries-13";
import { dailyLightVolumeSixEntries } from "../../data/daily-light-volume-six-entries";
import { dailyLightVolumeSixEntriesBatchTwo } from "../../data/daily-light-volume-six-entries-2";
import { dailyLightVolumeSixEntriesBatchThree } from "../../data/daily-light-volume-six-entries-3";
import { dailyLightVolumeSixEntriesBatchFour } from "../../data/daily-light-volume-six-entries-4";
import { dailyLightVolumeSixEntriesBatchFive } from "../../data/daily-light-volume-six-entries-5";
import { dailyLightVolumeSixEntriesBatchSix } from "../../data/daily-light-volume-six-entries-6";
import { dailyLightVolumeSixEntriesBatchSeven } from "../../data/daily-light-volume-six-entries-7";
import { dailyLightVolumeSixEntriesBatchEight } from "../../data/daily-light-volume-six-entries-8";
import { dailyLightVolumeSixEntriesBatchNine } from "../../data/daily-light-volume-six-entries-9";
import { dailyLightVolumeSixEntriesBatchTen } from "../../data/daily-light-volume-six-entries-10";
...
const allFallbackEntries = [
  ...
  ...dailyLightVolumeFourEntriesBatchThree,
  ...dailyLightVolumeFourEntriesBatchFour,
  ...dailyLightVolumeFourEntriesBatchFive,
  ...dailyLightVolumeFourEntriesBatchSix,
  ...dailyLightVolumeFourEntriesBatchSeven,
  ...dailyLightVolumeFiveEntries,
  ...dailyLightVolumeFiveEntriesBatchTwo,
  ...dailyLightVolumeFiveEntriesBatchThree,
  ...dailyLightVolumeFiveEntriesBatchFour,
  ...dailyLightVolumeFiveEntriesBatchFive,
  ...dailyLightVolumeFiveEntriesBatchSix,
  ...dailyLightVolumeFiveEntriesBatchSeven,
  ...dailyLightVolumeFiveEntriesBatchEight,
  ...dailyLightVolumeFiveEntriesBatchNine,
  ...dailyLightVolumeFiveEntriesBatchTen,
  ...dailyLightVolumeFiveEntriesBatchEleven,
  ...dailyLightVolumeFiveEntriesBatchTwelve,
  ...dailyLightVolumeFiveEntriesBatchThirteen,
  ...dailyLightVolumeSixEntries,
  ...dailyLightVolumeSixEntriesBatchTwo,
  ...dailyLightVolumeSixEntriesBatchThree,
  ...dailyLightVolumeSixEntriesBatchFour,
  ...dailyLightVolumeSixEntriesBatchFive,
  ...dailyLightVolumeSixEntriesBatchSix,
  ...dailyLightVolumeSixEntriesBatchSeven,
  ...dailyLightVolumeSixEntriesBatchEight,
  ...dailyLightVolumeSixEntriesBatchNine,
  ...dailyLightVolumeSixEntriesBatchTen,
